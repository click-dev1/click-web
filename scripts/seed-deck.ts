    ...
    afterLifecycle: [
      {
        ...
        numbered: true,
        cards: [
          ["Campaign Activation", "One campaign or moment", "Strategy, creators, content, execution, and measurement built around a defined objective and timeline."],
          ["Strategic Engagement", "Insight-led activation", "Start with audience intelligence to understand the opportunity, then translate those findings into creator strategy and campaign execution."],
          ["Enterprise Partnership", "Multiple campaigns over time", "Build an intelligence foundation, activate against it, measure what works, and use those learnings to continuously improve future campaigns and investment."],
          ["Enterprise AOR", "Always-on, compounding", "A continuous operating model that connects audience intelligence, creator strategy, activation, optimization, and scale across campaigns, markets, and the broader GameSquare ecosystem."],
